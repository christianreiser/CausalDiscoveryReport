...
\begin{center}
    ...
    %         \begin{tabular}{@{}lll@{}}
    %         \toprule
    %                  & conflict rate    & unorianted rate  \\ \midrule
    %          lagged  & 0.00               & 0.14                \\
    %          auto    & 0.00               & 0.17                \\
    %          contemporaneous & 0.09               & 0.05                \\
    %          total   & 0.03               & 0.13       \\ 
    %         \end{tabular}
...
% This means recall and precision of LPCMCI edgemark prediction is above 0.33 the algorithm performs better than random.
% We also calculate a score that shows how much better the LPCMCI algorithm performs compared to the random algorithm. the difference between the LPCMCI score and the random score and normalize it over the remaining are where the : $ (LPCMCI\_score-random\_score)/(1-random\_score)$
...
% Also the recall of 0.77 is considerably higher than the precision of 0.67. I don't know why.
